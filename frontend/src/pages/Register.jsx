    ...
    >
      ...
      <div className="relative my-1">
        ...
        <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-heading font-bold">
          <span className="bg-white px-3 text-[#888888]">or register with email</span>
        </div>
      </div>
      ...
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full h-12 text-xs uppercase font-heading tracking-wider mt-2 min-h-[44px]"
